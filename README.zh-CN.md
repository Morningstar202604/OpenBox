...
280+ 条人工精选资源，覆盖 14 个分类：免费模型 API、中转站、聊天镜像、免费服务器与域名、AI 应用、开发工具、学习资料。每条资源由自动巡检加社区投票共同把关——免费额度挂了，卡片上直接看得见，不用等注册踩坑。

在线访问：[openbox-nav.pages.dev](https://openbox-nav.pages.dev)
