...
export const sites: Site[] = [
  ...
  { id: 'clawapi', name: 'ClawApi (富利)', url: 'https://clawapi.fulitimes.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude全系', 'Codex'], desc: 'ClawApi是付费中转API，富利团队运营的国产付费中转。适合开发者，Claude 全系与 Codex 专项优化。', tagline: 'ClawApi｜国产Claude Code付费中转', features: ['付费', '国产'], apiBase: 'https://clawapi.fulitimes.com', note: '与富利Times 公益站同主体' },
