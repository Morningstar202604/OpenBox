...
export const sites: Site[] = [
  ...
  { id: 'aike-api', name: '艾可API', url: 'https://ai.wisech.com', category: 'paidrelay', type: 'freemium', status: 'ok', models: ['GPT', 'Claude', 'DeepSeek'], desc: '艾可API是付费中转API，国产低价中转含免费额度与低延迟。适合国内开发者，国产模型 7 折优惠。', tagline: '艾可API｜国产低价含免费额度', features: ['免费额度', '低延迟', '国产'], apiBase: 'https://ai.wisech.com', register: '开放注册', billing: '国产模型7折' },
