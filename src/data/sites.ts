...
export const sites: Site[] = [
  ...
  { id: 'aigcbar', name: 'AIGCBAR', url: 'https://aigcbar.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini', 'DeepSeek'], tagline: 'AIGCBAR｜多模型聚合付费中转', desc: 'AIGCBAR是付费中转API，聚合多模型支持套餐与按量。适合开发者与研究者，GPT、Claude、Gemini 可用。', apiBase: 'https://api.aigcbar.com/v1' },
  ...
  { id: '1000zhen', name: '1000Zhen', url: 'https://1000zhen.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude Code'], tagline: '1000Zhen｜Claude Code付费中转', desc: '1000Zhen是付费中转API，专注 Claude Code 的付费中转调用。适合开发者与研究者，编程场景可用。', apiBase: 'https://api.1000zhen.com/v1' },
