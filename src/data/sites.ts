...
{ id: 'aierxin', name: '尔信中转站', url: 'https://aierxin.cc', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude'], desc: '自建号池低倍率中转：gpt-pro 号池约官方 0.25 倍、混合池低至 0.08 倍；国内直连，公众号同步倍率动态。', tagline: '自建号池 · 低倍率 · 国内直连', features: ['按量计费', '号池', '国内直连'], apiBase: 'https://aierxin.cc' },
{ id: 'koozhan', name: '酷站AI', url: 'https://api.koozhan.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini'], desc: '第三方真伪检测平台 Veridrop 公开检测中位 99/100（297 样本），GPT/Claude/Gemini 主力型号全过检。', tagline: '公开检测高分的商用网关', features: ['按量计费', '检测背书'], apiBase: 'https://api.koozhan.com' },
{ id: 'runapi', name: 'RunAPI', url: 'https://runapi.host', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini', 'DeepSeek'], desc: '国内直连的 OpenRouter 式聚合路由，300+ 模型智能切换，支持 Claude Code / OpenClaw 一键接入。', tagline: '国内直连聚合路由', features: ['按量计费', '智能路由', '国内直连'], apiBase: 'https://runapi.host' },
];
