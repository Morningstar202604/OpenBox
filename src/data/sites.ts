...
export const sites: Site[] = [
  ...
  // ===== 付费商业中转站 (paidrelay) =====
  { id: 'closeai', name: 'CloseAI', url: 'https://closeai.us', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude', 'Gemini'], desc: 'CloseAI是付费中转API，最早的中转站之一按官方 1:1 比例计费。适合开发者与研究者，多模型价格透明。', tagline: 'CloseAI｜老牌付费中转官方1:1计费', features: ['付费', '多模型'], apiBase: 'https://api.closeai-proxy.xyz/v1', billing: '官方 1:1，部分模型加价' },
  { id: 'api2d', name: 'API2D', url: 'https://api2d.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude', 'Gemini'], desc: 'API2D是付费中转API，国内支持人民币支付的付费中转含多模型。适合国内开发者，GPT 与 Claude 可用。', tagline: 'API2D｜国产支持RMB支付中转', features: ['付费', '国产', '多模型'], apiBase: 'https://oa.api2d.net/v1', billing: '1 USD = 6 CNY，可叠加付费' },
  ...
  // ===== 国内大模型官方平台 (domestic) =====
  { id: 'siliconflow', name: '硅基流动', url: 'https://siliconflow.cn', category: 'domestic', type: 'freemium', status: 'ok', models: ['DeepSeek V3/R1', 'Qwen', 'GLM', 'Llama', 'Gemma'], desc: '硅基流动是免费模型API，聚合 DeepSeek、Qwen、GLM 等多模型且部分免费。适合国内开发者，低延迟按量计费（0.5~2元/M）。', tagline: '硅基流动｜国产多模型低延迟推理', features: ['大模型', '免费额度', '国产', '多模型', 'OpenAI兼容', '低延迟'], apiBase: 'https://api.siliconflow.cn/v1', billing: '部分模型免费，付费 0.5~2 元/M', note: '国内首选', pros: ['聚合多个开源模型', '部分模型完全免费', '国内直连速度快'], cons: ['免费模型有限', '高峰期可能排队'], tips: 'Qwen2.5-7B等小模型免费，适合轻量任务' },
  ...
  { id: '4router', name: '4Router', url: 'https://4router.net', category: 'paidrelay', type: 'freemium', status: 'ok', models: ['Claude', 'GPT'], desc: '4Router是付费中转API，低价中转含免费额度与低延迟。适合预算敏感用户，cheapClaude 仅 0.45x 倍率。', tagline: '4Router｜低价Claude 0.45x倍率中转', features: ['免费额度', '低延迟'], apiBase: 'https://4router.net', register: '开放注册', billing: 'cheapClaude 0.45x倍率' },
