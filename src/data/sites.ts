...
export const sites: Site[] = [
  ...
  { id: 'claudeapi', name: 'ClaudeAPI', url: 'https://claudeapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude全系'], desc: '专注 Claude API 中转，仅 Claude 系列，专业度高', tagline: '专注 Claude API 中转，专业度高', features: ['付费'], apiBase: 'https://api.claudeapi.com' },
  ...
  { id: 'rightcode-rc', name: 'RightCode (right.codes)', url: 'https://right.codes', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'Gemini', 'GPT'], desc: '专注 Claude/Gemini/GPT 三大主流模型低价中转', tagline: '专注 Claude/Gemini/GPT 三大主流中转', features: ['付费'], apiBase: 'https://api.right.codes', note: '区别于 rightcode.ai' },
  ...
  { id: 'token5u', name: 'Token5u', url: 'https://token5u.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '按 token 计费的聚合中转，价格透明', tagline: '按 token 计费聚合中转，价格透明', features: ['付费'], apiBase: 'https://api.token5u.com' },
  ...
  // ===== 国内大模型官方平台 (domestic) =====
  { id: 'siliconflow', name: '硅基流动', url: 'https://siliconflow.cn', category: 'domestic', type: 'freemium', status: 'ok', models: ['DeepSeek V3/R1', 'Qwen', 'GLM', 'Llama', 'Gemma'], desc: '硅基流动是免费模型API，聚合 DeepSeek、Qwen、GLM 等多模型且部分免费。适合国内开发者，低延迟按量计费（0.5~2元/M）。', tagline: '硅基流动｜国产多模型低延迟推理', features: ['免费额度', '国产', '多模型', '低延迟'], apiBase: 'https://api.siliconflow.cn/v1', billing: '部分模型免费，付费 0.5~2 元/M', note: '国内首选', pros: ['聚合多个开源模型', '部分模型完全免费', '国内直连速度快'], cons: ['免费模型有限', '高峰期可能排队'], tips: 'Qwen2.5-7B等小模型免费，适合轻量任务' },
  ...
  { id: 'aliyun-bailian', name: '阿里云百炼', url: 'https://bailian.console.aliyun.com', category: 'domestic', type: 'freemium', status: 'ok', models: ['Qwen3-Max', 'Qwen3-Coder', 'QwQ', 'Qwen-VL'], desc: '阿里云百炼是免费模型API，提供 Qwen3 系列官方模型含免费额度。适合国内开发者，国产按量计费即用。', tagline: '阿里云百炼｜Qwen官方多模型免费额度', features: ['免费额度', '国产', '多模型'], apiBase: 'https://dashscope.aliyuncs.com/compatible-mode/v1', billing: '部分免费，按量计费' },
  { id: 'tencent-hunyuan', name: '腾讯混元', url: 'https://cloud.tencent.com/product/hunyuan', category: 'domestic', type: 'freemium', status: 'ok', models: ['Hunyuan-Turbos', 'Hunyuan-Large', 'Hunyuan-Standard'], desc: '腾讯混元是免费模型API，提供 Hunyuan 系列官方模型与免费额度。适合国内开发者，国产按量计费即用。', tagline: '腾讯混元｜Hunyuan官方免费额度', features: ['免费额度', '国产'], apiBase: 'https://api.hunyuan.cloud.tencent.com/v1', billing: '免费额度 + 按量' },
  ...
  { id: 'bltcy-ai', name: '柏拉图AI', url: 'https://api.bltcy.ai', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], desc: '柏拉图AI是付费中转API，Azure 渠道低价 GPT 与 Claude 中转。适合企业级调用，官方渠道稳定性高。', tagline: '柏拉图AI｜Azure渠道低价付费中转', features: ['付费'], apiBase: 'https://api.bltcy.ai', register: '开放注册', billing: 'Azure渠道低价', payment: '支付宝/微信' },
