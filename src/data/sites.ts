...
export const sites: Site[] = [
  // ===== 社区公益站 (linuxdo) =====
  { id: 'gscc-relay', name: 'GSCC Relay', url: 'https://gsccrelay.space', category: 'blacklist', type: 'free', status: 'dead', models: ['Claude全系'], desc: '原公益站，域名已转卖为营销页', apiBase: 'https://gsccrelay.space', register: '公告发放 sk-key', blacklistReason: '域名转卖，现直接托管"极省创"营销博客（非 AI 中继服务）', blacklistReasonType: 'domain-sale' },
  ...
  { id: 'anyrouter', name: 'AnyRouter', url: 'https://anyrouter.top', category: 'freerelay', type: 'freemium', status: 'unknown', models: ['claude-sonnet-4', 'opus-4'], desc: '纯公益站，专注 Claude Code 中转，注册送 $50', tagline: '注册送 $50，每日签到 +$25', features: ['免费额度', '签到', '公益'], apiBase: 'https://anyrouter.top', billing: '注册送$50，邀请$100，每日签到$25', register: '教育邮箱或 Linux.do 账号', pros: ['注册送$50额度', '每日签到$25', '专注Claude Code中转'], cons: ['额度有限', '需教育邮箱或Linux.do账号'], tips: '配合Claude Code使用体验最佳。2026-08-22 补充：官方另有大陆优化后端线路 a-ocnfniawgw.cn-shanghai.fcapp.run；社区报告近期有限流与波动，遇 503 可重试' },
  { id: 'duckcoding-free', name: 'DuckCoding Free', url: 'https://free.duckcoding.com', category: 'linuxdo', type: 'freemium', status: 'unknown', models: ['Claude Code', 'GPT'], desc: '原 InstCopilot API，公益分组特定时段 0.2 倍率，文档完善', tagline: '公益分组特定时段 0.2 倍率，文档完善', features: ['免费额度', '公益', 'Linux.do'], apiBase: 'https://free.duckcoding.com', register: 'Linux.do 账号', pros: ['公益分组0.2倍率', '文档完善', '稳定运营'], cons: ['需Linux.do账号', '特定时段才有优惠'], tips: '关注公益分组时段，错峰使用更划算' },
  ...
  { id: 'rawchat-codex', name: 'RawChat Codex 公益站', url: 'https://new.sharedchat.cc/', category: 'linuxdo', type: 'free', status: 'ok', models: ['Codex', 'GPT'], desc: '每日 100 美元额度，无需登录', tagline: '每日 100 美元额度，无需登录', features: ['免费', '公益', '无需注册'], note: '主站 chatgptplus.cn；社区共享付费账号，可能违反 OpenAI ToS，风险自负' },
  { id: 'rawchat', name: 'RawChat 主站', url: 'https://chatgptplus.cn', category: 'freechat', type: 'free', status: 'ok', models: ['GPT-4o', 'Plus全套'], desc: 'RawChat 主站是免费模型API，提供无需注册的公益共享 Plus 账号。适合新手与开发者，免登录即可体验 GPT-4o。（社区共享付费账号，可能违反 OpenAI ToS，风险自负）', tagline: 'RawChat 主站｜免费公益共享Plus账号', features: ['免费', '公益', '无需注册'], note: '社区共享付费账号，可能违反 OpenAI ToS，风险自负' },
  ...
  { id: 'agentrouter', name: 'AgentRouter', url: 'https://agentrouter.org', category: 'linuxdo', type: 'freemium', status: 'unknown', models: ['Claude Opus/Sonnet', 'GPT-5', 'Gemini', 'Qwen'], desc: '面向开发者的公益 AI 编程平台，邀请注册送 $100-200，支持 Claude Code/Codex/Gemini CLI/Roo Code/Qwen Code', tagline: '注册送 $200，支持多 Agent 工具', features: ['免费额度', '公益', '多模型'], apiBase: 'https://agentrouter.org', register: 'GitHub 或 Linux.do', note: 'GitHub 老号奖励更高' },
  { id: 'hajimi', name: '哈基米 API', url: 'https://api.gemai.cc', category: 'linuxdo', type: 'freemium', status: 'ok', models: ['Claude全系', 'GPT', 'Gemini'], desc: '哈基米 API是免费模型API，注册送免费额度并支持每日签到。适合国内开发者，邮箱注册即可用 Claude、GPT、Gemini。', tagline: '哈基米 API｜国产免费额度邮箱注册', features: ['免费额度', '签到', '国产', '邮箱注册'], apiBase: 'https://api.gemai.cc', register: '邮箱', note: '充值也便宜' },
  ...
  { id: 'wenwen-ai', name: '文文 AI', url: 'https://code.wenwen-ai.com', category: 'linuxdo', type: 'free', status: 'unstable', models: ['Claude Code'], desc: '文文 AI是免费模型API，提供免费的 Claude Code 中转端点。适合开发者，公益免费但稳定性一般需备用。', tagline: '文文 AI｜免费公益Claude Code中转', features: ['免费', '公益'], apiBase: 'https://code.wenwen-ai.com', note: '备用 breakout.wenwen-ai.com' },
  ...
  { id: 'aiyunos', name: '爱云网', url: 'https://chat5.aiyunos.top', category: 'freechat', type: 'free', status: 'dead', models: ['GPT-4'], desc: '仓库赞助商，WAF 防护页可达，多模型', tips: '2026-08-22 实测：页面仅剩空壳、标题显示 AItianhu（疑似换壳弃用），服务不可用' },
  { id: 'wendabao', name: 'ai.wendabao.net', url: 'https://ai.wendabao.net', category: 'freechat', type: 'free', status: 'dead', models: ['GPT-4'], desc: '仓库赞助商站点', tips: '2026-08-22 实测：官方挂出「服务暂停通知」，原网址已停止服务（页面留有推荐替代链接）' },
  ...
  { id: 'kelaode', name: 'kelaode.ai', url: 'https://kelaode.ai/', category: 'overseas', type: 'free', status: 'unknown', models: ['Claude Pro'], desc: 'Claude 镜像站，含 Pro 账号，需海外网络', note: '国内直连超时（15s），海外可用' },
  ...
  { id: 'bixin', name: '1.bixin123.com', url: 'https://1.bixin123.com', category: 'freechat', type: 'free', status: 'dead', models: ['ChatGPT'], desc: '免费 ChatGPT 对话', tips: '2026-08-22 实测：页面长期停留在「Ai Loading」加载页无法进入，服务不可用' },
  ...
  { id: 'chatanywhere', name: 'ChatAnywhere', url: 'https://chatanywhere.com', category: 'freerelay', type: 'freemium', status: 'unknown', models: ['GPT全系', 'Claude', 'DeepSeek'], desc: '老牌免费 API 中转，公益组免费 $0，GPT-4 高级组需邀请', tagline: '老牌公益组免费，GPT-4 高级组需邀请', features: ['免费额度', '国产', '公益'], apiBase: 'https://api.chatanywhere.tech/v1', billing: '公益组免费，高级组需邀请', register: 'GitHub 申请', note: '国内首选' },
  { id: 'popjane', name: 'PopJane', url: 'https://api.popjane.com', category: 'freerelay', type: 'freemium', status: 'unknown', models: ['Claude', 'GPT'], desc: '免费 OpenAI/Claude 代理，按需返利', tagline: '免费 OpenAI/Claude 代理，按需返利', features: ['免费额度', '海外'], apiBase: 'https://api.popjane.com/v1', register: '注册获取 Key' },
  ...
  // ===== 付费商业中转站 (paidrelay) =====
  { id: 'closeai', name: 'CloseAI', url: 'https://closeai.us', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude', 'Gemini'], desc: 'CloseAI是付费中转API，最早的中转站之一，按官方比例计费（部分模型加价）。适合开发者与研究者，多模型价格透明。', tagline: 'CloseAI｜老牌付费中转，按官方比例计费', features: ['付费', '多模型'], apiBase: 'https://api.closeai-proxy.xyz/v1', billing: '按官方比例计费，部分模型加价' },
  { id: 'api2d', name: 'API2D', url: 'https://api2d.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude', 'Gemini'], desc: 'API2D是付费中转API，国内支持人民币支付的付费中转含多模型。适合国内开发者，GPT 与 Claude 可用。', tagline: 'API2D｜国产支持RMB支付中转', features: ['付费', '国产', '多模型'], apiBase: 'https://oa.api2d.net/v1', billing: '美元计价，人民币支付（汇率以站内为准）' },
  ...
  { id: 'ohmygpt', name: 'OhMyGPT', url: 'https://www.ohmygpt.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini', 'Midjourney'], desc: '运营时间长，支持微信/支付宝，含图像模型', tagline: '运营时间长，支持微信/支付宝', features: ['付费', '国产', '多模型'], apiBase: 'https://api.ohmygpt.com/v1', billing: '官方 1:1.05~1.3' },
  ...
  { id: 'openaimax', name: 'OpenAIMax', url: 'https://openaimax.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '转发 GPT/Claude/Gemini，多渠道负载均衡', apiBase: 'https://api.openaimax.com/v1' },
  { id: 'api2gpt', name: 'API2GPT', url: 'https://api2gpt.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], tagline: 'API2GPT｜多模型聚合付费中转', desc: 'API2GPT是付费中转API，多模型聚合付费中转支持套餐调用。适合开发者与研究者，GPT 与 Claude 可用。', apiBase: 'https://api.api2gpt.com/v1' },
  { id: 'aigc2d', name: 'AIGC2D', url: 'https://aigc2d.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Stable Diffusion'], tagline: 'AIGC2D｜图文多模型付费中转', desc: 'AIGC2D是付费中转API，聚合 OpenAI、Anthropic 与图像模型。适合开发者与研究者，GPT、Claude、SD 可用。', apiBase: 'https://api.aigc2d.com/v1' },
  { id: 'aiproxy', name: 'AIProxy', url: 'https://aiproxy.io', category: 'paidrelay', type: 'paid', status: 'dead', models: ['GPT', 'Claude'], tagline: 'AIProxy｜已停运（2025 年底关站）', desc: 'AIProxy 原为付费中转 API，已于 2025 年底停运，域名现为第三方停运说明页，请勿再依赖。', apiBase: 'https://api.aiproxy.io/v1' },
  ...
  { id: '4sapi', name: '4SAPI', url: 'https://4sapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转，支持套餐', apiBase: 'https://api.4sapi.com/v1' },
  ...
  { id: 'wts', name: 'WTS', url: 'https://wts.ai', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '低价 GPT/Claude 中转', apiBase: 'https://api.wts.ai/v1' },
  { id: 'aigcbar', name: 'AIGCBAR', url: 'https://aigcbar.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini', 'DeepSeek'], tagline: 'AIGCBAR｜多模型聚合付费中转（状态存疑）', desc: 'AIGCBAR是付费中转API，聚合多模型支持套餐与按量。适合开发者与研究者，GPT、Claude、Gemini 可用。', apiBase: 'https://api.aigcbar.com/v1', tips: '2026-08-22 实测：首页仅剩标题占位页，服务疑似停摆/迁移，接入前务必自测' },
  { id: 'ofox', name: 'Ofox', url: 'https://ofox.cc', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT'], desc: '低价中转，支持 Claude Code', apiBase: 'https://api.ofox.cc/v1' },
  { id: 'apiyi', name: 'API易', url: 'https://apiyi.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini'], tagline: 'API易｜国内付费多模型中转', desc: 'API易是付费中转API，国内付费中转聚合 GPT、Claude、Gemini。适合开发者与研究者，多模型稳定调用。', apiBase: 'https://api.apiyi.com/v1' },
  { id: 'bltcy', name: 'BLTCY', url: 'https://bltcy.cc', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT'], desc: 'Claude Code 专用中转，低价稳定', apiBase: 'https://api.bltcy.cc/v1' },
  { id: 'chatfire', name: 'ChatFire', url: 'https://chatfire.net', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转，支持多协议', apiBase: 'https://api.chatfire.net/v1' },
  ...
  { id: 'yuegle', name: 'Yuegle', url: 'https://yuegle.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT'], desc: 'Claude 低价中转，按 token 计费', apiBase: 'https://api.yuegle.com/v1' },
  ...
  { id: 'gptgod', name: 'GPTGod', url: 'https://gptgod.tw', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '台湾节点，海外加速稳定', apiBase: 'https://api.gptgod.tw/v1' },
  ...
  { id: 'lingyaai', name: '凌鸦 AI', url: 'https://lingyaai.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '低价中转，含图像模型', apiBase: 'https://api.lingyaai.com/v1' },
  { id: 'paintbot', name: 'PaintBot', url: 'https://paintbot.cn', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT'], desc: 'Claude Code 中转，低价', apiBase: 'https://api.paintbot.cn/v1' },
  ...
  { id: 'apimart', name: 'APIMart', url: 'https://apimart.net', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '中转聚合，多渠道', apiBase: 'https://api.apimart.net/v1' },
  ...
  { id: 'ephone', name: 'Ephone', url: 'https://ephone.dev', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT'], desc: 'Claude Code 中转，低价稳定', apiBase: 'https://api.ephone.dev/v1' },
  { id: 'duckllm', name: 'DuckLLM', url: 'https://duckllm.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], tagline: 'DuckLLM｜稳定付费中转支持套餐', desc: 'DuckLLM是付费中转API，稳定中转支持套餐调用。适合开发者与研究者，GPT 与 Claude 可用。', apiBase: 'https://api.duckllm.com/v1' },
  { id: 'apipool', name: 'APIPool', url: 'https://apipool.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '多渠道中转池', apiBase: 'https://api.apipool.com/v1' },
  { id: '88api', name: '88API', url: 'https://88api.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '低价中转，社区活跃', apiBase: 'https://api.88api.com/v1' },
  { id: 'aigcbest', name: 'AIGCBest', url: 'https://aigcbest.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '聚合中转，按 token 计费', apiBase: 'https://api.aigcbest.com/v1' },
  ...
  { id: '147api', name: '147API', url: 'https://147api.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转，支持套餐', apiBase: 'https://api.147api.com/v1' },
  ...
  { id: 'n1n', name: 'N1N', url: 'https://n1n.cn', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '低价中转，社区运营', apiBase: 'https://api.n1n.cn/v1' },
  { id: '0011', name: '0011 API', url: 'https://0011.cc', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '中转聚合', apiBase: 'https://api.0011.cc/v1' },
  { id: 'coderplan', name: 'CoderPlan', url: 'https://coderplan.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code', 'GPT'], desc: 'Claude Code 专用中转', apiBase: 'https://api.coderplan.com/v1' },
  { id: 'ccsub', name: 'CCSub', url: 'https://ccsub.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 订阅制中转', apiBase: 'https://api.ccsub.com/v1' },
  { id: 'atlascloud', name: 'AtlasCloud', url: 'https://atlascloud.cn', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转，企业级', apiBase: 'https://api.atlascloud.cn/v1' },
  { id: 'apinebula', name: 'APINebula', url: 'https://apinebula.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '聚合中转，多渠道负载', apiBase: 'https://api.apinebula.com/v1' },
  { id: 'apikeyfun', name: 'APIKeyFun', url: 'https://apikeyfun.com', category: 'paidrelay', type: 'paid', status: 'unstable', models: ['GPT', 'Claude'], tagline: 'APIKeyFun｜付费中转（近期源站超时）', desc: 'APIKeyFun是付费中转API，稳定中转支持套餐调用。适合开发者与研究者，GPT 与 Claude 可用。', apiBase: 'https://api.apikeyfun.com/v1', tips: '2026-08-19 探测 522 源站超时，需人工复核' },
  ...
  { id: 'micuapi', name: 'MicuAPI', url: 'https://micuapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '聚合中转', apiBase: 'https://api.micuapi.com/v1' },
  { id: 'sssaicode', name: 'SSSAICode', url: 'https://sssaicode.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.sssaicode.com/v1' },
  ...
  { id: 'crazyrouter', name: 'CrazyRouter', url: 'https://crazyrouter.cn', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '聚合中转，社区活跃', apiBase: 'https://api.crazyrouter.cn/v1' },
  { id: 'uyunzhisuan', name: 'U云智算', url: 'https://uyunzhisuan.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '云算中转，支持套餐', apiBase: 'https://api.uyunzhisuan.com/v1' },
  { id: 'cubence', name: 'Cubence', url: 'https://cubence.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], tagline: 'Cubence｜聚合付费中转', desc: 'Cubence是付费中转API，聚合多模型付费中转调用。适合开发者与研究者，GPT 与 Claude 可用。', apiBase: 'https://api.cubence.com/v1' },
  { id: 'patewayai', name: 'PatewayAI', url: 'https://patewayai.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转', apiBase: 'https://api.patewayai.com/v1' },
  { id: '1000zhen', name: '千帧 AI（1000Zhen，已转型）', url: 'https://1000zhen.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Seedance', 'Veo', 'Nano Banana', 'GPT-Image'], tagline: '千帧AI｜AI图像视频生成工具平台（原Claude Code中转已转型）', desc: '千帧AI已从 Claude Code 中转转型为第三方 AI 工具聚合平台：Seedance/Veo 视频生成、Nano Banana/GPT-Image 绘图、共享号池对话与在线工具箱，按量付费。适合创作者与研究者。', apiBase: 'https://api.1000zhen.com/v1', tips: '2026-08-22 实测：官网已转型为图像/视频生成工具站，原 API 中转业务是否保留未验证' },
  { id: 'loomcode', name: 'LoomCode', url: 'https://loomcode.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.loomcode.com/v1' },
  { id: '9527code', name: '9527Code', url: 'https://9527code.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.9527code.com/v1' },
  ...
  { id: 'aicodemirror', name: 'AICodeMirror', url: 'https://aicodemirror.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.aicodemirror.com/v1' },
  { id: 'aigocode', name: 'AIGOCode', url: 'https://aigocode.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.aigocode.com/v1' },
  { id: 'packycode', name: 'PackyCode', url: 'https://packycode.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude Code'], desc: 'Claude Code 中转', apiBase: 'https://api.packycode.com/v1' },
  { id: 'freemodelai', name: 'FreeModelAI', url: 'https://freemodelai.com', category: 'paidrelay', type: 'freemium', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '部分模型免费额度', apiBase: 'https://api.freemodelai.com/v1' },
  ...
  { id: 'aihubhkcn', name: 'AIHub HK/CN', url: 'https://aihubhkcn.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '香港/大陆双节点', apiBase: 'https://api.aihubhkcn.com/v1' },
  ...
  { id: 'jiekouvip', name: '接口VIP', url: 'https://jiekouvip.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转', apiBase: 'https://api.jiekouvip.com/v1' },
  { id: 'highwayapi', name: 'HighwayAPI', url: 'https://highwayapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '稳定中转，多渠道', apiBase: 'https://api.highwayapi.com/v1' },
  { id: 'levolink', name: 'Levolink', url: 'https://levolink.com', category: 'overseas', type: 'paid', status: 'unknown', models: ['Claude Code', 'GPT'], desc: 'Claude Code 中转', apiBase: 'https://api.levolink.com/v1', note: '国内直连 SSL 异常，需海外网络' },
  ...
  { id: 'tokenrunning', name: 'TokenRunning', url: 'https://tokenrunning.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '按 token 计费', apiBase: 'https://api.tokenrunning.com/v1' },
  ...
  { id: 'aifast', name: 'AIFast', url: 'https://aifast.com', category: 'paidrelay', type: 'paid', status: 'dead', models: ['GPT', 'Claude'], tagline: 'AIFast｜已失效（域名易主）', desc: 'AIFast 原为付费中转 API，2026-08 实测域名已易主为无关网站（美国紧固件公司），原 AI 中转服务已停运，请勿再依赖。', apiBase: 'https://api.aifast.com/v1', note: '域名易主，服务停运' },
  { id: 'lemonapi', name: 'LemonAPI', url: 'https://lemonapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '聚合中转，低价', apiBase: 'https://api.lemonapi.com/v1' },
  { id: 'lmuai', name: '灵眸 AI', url: 'https://api.lmuai.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude全系', 'GPT', 'Gemini'], desc: '灵眸 AI是付费中转API，国内服务器直连的低延迟付费中转。适合国内开发者，按 token 计费（约 ¥2.4/$）。', tagline: '灵眸 AI｜国产低延迟付费中转', features: ['付费', '国产', '低延迟'], apiBase: 'https://api.lmuai.com', billing: '内部汇率 ¥2.4/$，按 token 计费', register: '邮箱', note: 'Claude Code 性价比首选，配合 Prompt Cache 可省 90%' },
  { id: 'clawapi', name: 'ClawApi (富利，已下线)', url: 'https://clawapi.fulitimes.com', category: 'paidrelay', type: 'paid', status: 'dead', models: ['Claude全系', 'Codex'], desc: 'ClawApi是付费中转API，富利团队运营的国产付费中转。适合开发者，Claude 全系与 Codex 专项优化。', tagline: 'ClawApi｜国产Claude Code付费中转', features: ['付费', '国产'], apiBase: 'https://clawapi.fulitimes.com', note: '与富利Times 公益站同主体', tips: '2026-08-22 实测：域名现指向「灵眸 AI (LMU AI)」同款站点，原 ClawApi 服务已不存在（疑更名合并至 api.lmuai.com）' },
  ...
  { id: 'shenma', name: '神马中转', url: 'https://api.whatai.cc', category: 'paidrelay', type: 'paid', status: 'ok', models: ['650+ 模型', 'GPT', 'Claude', 'Gemini', 'DeepSeek'], desc: '神马中转是付费中转API，国产聚合 650+ 模型覆盖主流商用与开源。适合开发者，价格透明按 token 计费。', tagline: '神马中转｜国产聚合多模型付费中转', features: ['付费', '国产', '多模型'], apiBase: 'https://api.whatai.cc', billing: '按 token 计费' },
  { id: 'claudeapi', name: 'ClaudeAPI', url: 'https://claudeapi.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude全系'], desc: '专注 Claude API 中转，仅 Claude 系列，专业度高', tagline: '专注 Claude API 中转，专业度高', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.claudeapi.com' },
  { id: 'poixe', name: 'Poixe AI', url: 'https://poixe.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude', 'GPT', 'Gemini'], desc: '2024 年开始运营的聚合中转，文档简洁，社区口碑良好', tagline: '2024 年新运营聚合中转，社区口碑良好', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.poixe.com' },
  { id: 'rightcode-rc', name: 'RightCode (right.codes)', url: 'https://right.codes', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'Gemini', 'GPT'], desc: '专注 Claude/Gemini/GPT 三大主流模型低价中转', tagline: '专注 Claude/Gemini/GPT 三大主流中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.right.codes', note: '区别于 rightcode.ai' },
  { id: 'shiyunapi', name: 'ShiyunApi 诗云API', url: 'https://shiyunapi.com', category: 'blacklist', type: 'paid', status: 'dead', models: ['GPT', 'Claude'], desc: '原付费中转，2026-06 已停运，官网重定向至 TokenRiver（tokenriver.cn），原用户需迁移并重新申请 Key', tagline: '已停运 · 迁移至 TokenRiver', features: ['已停运'], apiBase: 'https://api.shiyunapi.com', blacklistReason: 'service-stopped' },
  { id: 'eflowcode', name: 'E-FlowCode', url: 'https://e-flowcode.cc', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude Code', 'Codex'], desc: 'Claude Code / Codex 专用中转，按 token 计费', tagline: 'Claude Code / Codex 专用中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.e-flowcode.cc' },
  { id: 'lxapi', name: 'LX_API', url: 'https://lxtech.icu', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Claude Code', 'GPT'], desc: 'Claude Code 中转，按 token 计费，社区活跃', tagline: 'Claude Code 中转，社区活跃', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.lxtech.icu' },
  { id: 'token5u', name: 'Token5u', url: 'https://token5u.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '按 token 计费的聚合中转，价格透明', tagline: '按 token 计费聚合中转，价格透明', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.token5u.com' },
  { id: 'hvoyai', name: 'hvoy.ai', url: 'https://hvoy.ai', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['Claude', 'GPT', 'Gemini'], desc: '海外节点中转，支持 GPT/Claude/Gemini 多模型', tagline: '海外节点中转，多模型聚合', features: ['付费', '海外'], apiBase: 'https://api.hvoy.ai' },
  { id: 'apimiao', name: 'API秒', url: 'https://apimiao.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '社区提及的低价中转', tagline: '社区提及低价中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.apimiao.com' },
  { id: 'janyai', name: '简易 API', url: 'https://janyai.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude'], desc: '社区提及的聚合中转', tagline: '社区提及聚合中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.janyai.com' },
  ...
  { id: 'ofox-ai', name: 'OFox AI', url: 'https://ofox.ai', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '社区推荐聚合中转，界面简洁', tagline: '社区推荐聚合中转，界面简洁', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.ofox.ai' },
  { id: 'tokenmix', name: 'TokenMix', url: 'https://tokenmix.ai', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '社区推荐聚合中转，按 token 计费', tagline: '社区推荐按 token 计费', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.tokenmix.ai' },
  { id: 'b-ai', name: 'B.AI', url: 'https://b.ai', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '简洁域名 AI 中转，社区推荐', tagline: '简洁域名 AI 中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.b.ai' },
  { id: 'nanobanana', name: 'NanoBanana', url: 'https://nanobanana.com', category: 'paidrelay', type: 'paid', status: 'unknown', models: ['GPT', 'Claude', 'Gemini'], desc: '社区推荐聚合中转，低价策略', tagline: '社区推荐低价中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.nanobanana.com' },
  ...
  // ===== 国内大模型官方平台 (domestic) =====
  { id: 'siliconflow', name: '硅基流动', url: 'https://siliconflow.cn', category: 'domestic', type: 'freemium', status: 'ok', models: ['DeepSeek V3/R1', 'Qwen', 'GLM', 'Llama', 'Gemma'], desc: '硅基流动是免费模型API，聚合 DeepSeek、Qwen、GLM 等多模型且部分免费。适合国内开发者，低延迟、小模型免费、付费按量计费（单价以官网为准）。', tagline: '硅基流动｜国产多模型低延迟推理', features: ['大模型', '免费额度', '国产', '多模型', 'OpenAI兼容', '低延迟'], apiBase: 'https://api.siliconflow.cn/v1', billing: '部分模型免费，付费按量计费（以官网为准）', note: '国内首选', pros: ['聚合多个开源模型', '部分模型完全免费', '国内直连速度快'], cons: ['免费模型有限', '高峰期可能排队'], tips: 'Qwen2.5-7B等小模型免费，适合轻量任务' },
  ...
  { id: 'aliyun-bailian', name: '阿里云百炼', url: 'https://bailian.console.aliyun.com', category: 'domestic', type: 'freemium', status: 'ok', models: ['Qwen3-Max', 'Qwen3-Coder', 'QwQ', 'Qwen-VL'], desc: '阿里云百炼是免费模型API，提供 Qwen3 系列官方模型含免费额度。适合国内开发者，国产按量计费即用。', tagline: '阿里云百炼｜Qwen官方多模型免费额度', features: ['大模型', '免费额度', '国产', '多模型', 'OpenAI兼容'], apiBase: 'https://dashscope.aliyuncs.com/compatible-mode/v1', billing: '部分免费，按量计费' },
  { id: 'tencent-hunyuan', name: '腾讯混元', url: 'https://cloud.tencent.com/product/hunyuan', category: 'domestic', type: 'freemium', status: 'ok', models: ['Hunyuan-Turbos', 'Hunyuan-Large', 'Hunyuan-Standard'], desc: '腾讯混元是免费模型API，提供 Hunyuan 系列官方模型与免费额度。适合国内开发者，国产按量计费即用。', tagline: '腾讯混元｜Hunyuan官方免费额度', features: ['大模型', '免费额度', '国产', 'OpenAI兼容', '多模型'], apiBase: 'https://api.hunyuan.cloud.tencent.com/v1', billing: '免费额度 + 按量' },
  ...
  { id: 'aiproxy-best', name: 'aiproxy.best', url: 'https://aiproxy.best', category: 'tool', type: 'free', status: 'ok', models: ['GPT', 'Claude'], tagline: 'aiproxy.best｜AI 中转站聚合导航与对比', desc: 'aiproxy.best 是 AI 中转站聚合导航与对比站，提供多站点收录与比选。适合开发者与研究者，一站式查找免费中转服务。' },
  ...
  { id: 'apinav', name: 'APINav 导航', url: 'https://apinav.cc', category: 'tool', type: 'free', status: 'ok', models: ['GPT', 'Claude'], desc: 'APINav 导航 是 AI 中转站导航站，按免费/付费/公益分类收录 137+ 站点。适合开发者选型，集中比选中转服务。', tagline: 'APINav 导航｜AI 中转站导航，已收录 137+ 站点', features: ['免费', '导航'], note: '中转站发现参考' },
  { id: 'aj80', name: '80aj 公益站汇总', url: 'https://80aj.com', category: 'tool', type: 'free', status: 'ok', models: ['GPT', 'Claude'], desc: '80aj 公益站汇总 是公益站与中转站汇总指南发布站，定期更新清单与使用教程。适合找免费公益资源，信息持续更新。', tagline: '80aj 公益站汇总｜公益/中转站清单与教程发布站', features: ['免费', '公益', '导航'], note: '公益站动态参考' },
  ...
  // ===== 黑名单（失效站点，单独追加）=====
  { id: 'zhiyunapi', name: 'ZhiyunApi', url: 'https://zhiyunapi.com', category: 'blacklist', type: 'paid', status: 'dead', models: ['GPT', 'Claude'], desc: '原付费中转站，站点已被管理员停止运行', tagline: '站点已被管理员停止运行', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.zhiyunapi.com', blacklistReason: '站点已被管理员停止运行（"抱歉！该站点已经被管理员停止运行"）', blacklistReasonType: 'service-stopped' },

  // ===== [新增] 社区公益站 (linuxdo) =====
  { id: 'huan666', name: 'Huan666', url: 'https://ai.huan666.de', category: 'linuxdo', type: 'freemium', status: 'ok', models: ['Claude全系', 'DeepSeek-R1', 'Grok-4', 'Kimi-K2', 'GLM-4.5'], desc: 'Huan666是免费模型API，Linux.do 社区公益站覆盖 Claude、Grok、DeepSeek 等多模型。适合开发者，免费额度按 token 计费。', tagline: 'Huan666｜Linux.do公益多模型免费', features: ['免费额度', '公益', 'Linux.do', '多模型'], apiBase: 'https://ai.huan666.de', register: 'Linux.do OAuth', note: 'Grok系列极低倍率，约 $0.01/M token' },
  ...
  { id: 'ggboom', name: 'GGBOOM公益站', url: 'https://ai.qaq.al', category: 'linuxdo', type: 'free', status: 'ok', models: ['GPT', 'Codex'], desc: 'GGBOOM公益站是免费模型API，Linux.do 社区开放注册即可免费用 GPT 与 Codex。适合开发者，稳定公益站点。', tagline: 'GGBOOM公益站｜Linux.do公益免费GPT/Codex', features: ['免费', '公益', 'Linux.do'], register: '开放注册' },
  ...
  { id: 'anticode', name: 'AntiCode', url: 'https://anticode.cn', category: 'linuxdo', type: 'freemium', status: 'ok', models: ['GPT', 'Claude'], desc: 'AntiCode是免费模型API，Linux.do 社区站注册送免费额度，支持 GPT 与 Claude。适合个人开发者轻量使用。', tagline: 'AntiCode｜Linux.do免费额度GPT/Claude', features: ['免费额度', 'Linux.do'], apiBase: 'https://anticode.cn', register: '开放注册', note: '支持 CC Switch、Cherry Studio' },
  { id: 'aizzz', name: 'AIZZZ', url: 'https://api.aizzz.xyz', category: 'linuxdo', type: 'freemium', status: 'unknown', models: ['GPT', 'Claude'], desc: 'AIZZZ是免费模型API，Linux.do 社区站注册送免费额度，支持 GPT 与 Claude。适合个人开发者轻量使用。', tagline: 'AIZZZ｜Linux.do免费额度GPT/Claude', features: ['免费额度', 'Linux.do'], apiBase: 'https://api.aizzz.xyz', register: '开放注册', tips: '2026-08-22 实测：全站被 WAF/403 拦截（标题 403 Forbidden），无法自动验证，接入前需自测' },
  { id: 'huainova', name: 'Huainova公益站', url: 'https://ai.huaibao.top', category: 'linuxdo', type: 'free', status: 'unstable', models: ['Claude', 'GPT'], desc: 'Huainova公益站是免费模型API，Linux.do 社区公益站免费调用 Claude 与 GPT。适合开发者，稳定性一般建议作备用。', tagline: 'Huainova公益站｜Linux.do免费Claude/GPT', features: ['免费', '公益', 'Linux.do'], register: 'Linux.do 账号', note: '渠道失效待恢复' },

  // ===== [新增] 付费商业中转站 (paidrelay) =====
  { id: 'hezu-ink', name: '合租巴士', url: 'https://hezu.ink', category: 'paidrelay', type: 'freemium', status: 'unknown', models: ['Codex', 'GPT', 'Claude'], desc: '低价商业中转站，开放注册赠送免费额度，支持 Codex、GPT、Claude 多模型。Codex 补贴分组仅 0.08x 倍率，延迟低、性价比高，适合代码辅助场景。', tagline: 'Codex 补贴分组 0.08x 倍率', features: ['免费额度', '低延迟'], apiBase: 'https://hezu.ink', register: '开放注册', billing: 'Codex补贴分组0.08x倍率' },
  { id: 'aike-api', name: '艾可API', url: 'https://ai.wisech.com', category: 'paidrelay', type: 'freemium', status: 'unknown', models: ['GPT', 'Claude', 'DeepSeek'], desc: '艾可API是付费中转API，国产低价中转含免费额度与低延迟。适合国内开发者，国产模型 7 折优惠。', tagline: '艾可API｜国产低价含免费额度', features: ['免费额度', '低延迟', '国产'], apiBase: 'https://ai.wisech.com', register: '开放注册', billing: '国产模型7折' },
  { id: '4router', name: '4Router', url: 'https://4router.net', category: 'paidrelay', type: 'freemium', status: 'ok', models: ['Claude', 'GPT'], desc: '4Router是付费中转API，低价中转含免费额度与低延迟。适合预算敏感用户，cheapClaude 有低倍率分组。', tagline: '4Router｜低价 Claude 低倍率中转', features: ['免费额度', '低延迟'], apiBase: 'https://4router.net', register: '开放注册', billing: '分组倍率制（具体倍率以站内为准）', tips: '2026-08-23 审计：cheapClaude 分组约 0.45x 倍率（时点数据，随时可调）' },
  { id: 'krill-ai', name: 'Krill AI', url: 'https://www.krill-ai.com', category: 'paidrelay', type: 'freemium', status: 'unknown', models: ['Grok', 'GPT', 'Claude'], desc: '中转站，开放注册赠送免费额度，支持 Grok、GPT、Claude 模型。Grok 提供专属免费额度，适合想低成本体验 Grok 系列的开发者。', tagline: '注册送 Grok 免费额度', features: ['免费额度'], apiBase: 'https://www.krill-ai.com', register: '开放注册', billing: 'Grok免费额度' },
  { id: 'fastaitoken', name: 'FastAI模型', url: 'https://www.fastaitoken.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['Grok', 'GPT', 'Claude'], desc: '付费中转站，支持 Grok、GPT、Claude 模型，按 token 计费。Grok 约 0.03 倍率，价格极低，适合大量调用 Grok 的场景。', tagline: 'Grok 约 0.03 倍率，极低价', features: ['付费', 'OpenAI兼容'], apiBase: 'https://www.fastaitoken.com', register: '开放注册', billing: 'Grok约0.03倍率' },
  { id: 'horizon-api', name: 'Horizon API', url: 'https://api.honglin.asia', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], desc: 'Horizon API是付费中转API，主打低价 GPT 的国内低延迟中转。适合国内开发者，GPT 与 Claude 可用。', tagline: 'Horizon API｜国内低延迟低价GPT中转', features: ['付费', '低延迟'], apiBase: 'https://api.honglin.asia', register: '开放注册', billing: '低价GPT' },
  { id: 'tokenskingdom', name: 'Tokens Kingdom', url: 'https://tokenskingdom.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], desc: '付费中转站，支持 GPT 与 Claude 模型，按 token 计费。价格透明，开放注册，适合稳定商用的开发者。', tagline: 'GPT/Claude 付费中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://tokenskingdom.com', register: '开放注册' },
  { id: 'yunwu', name: '云雾API', url: 'https://yunwu.ai', category: 'paidrelay', type: 'paid', status: 'unstable', models: ['GPT全系', 'Claude', 'Gemini', 'DeepSeek', 'Grok'], desc: '老牌付费中转站，聚合 GPT 全系、Claude、Gemini、DeepSeek 等多模型，按量计费。支持支付宝/微信支付，模型覆盖全面，适合多模型混合调用。', tagline: '多模型聚合，按量计费', features: ['付费', '多模型'], apiBase: 'https://api.yunwu.ai/v1', register: '开放注册', billing: '按量计费', payment: '支付宝/微信', pros: ['多渠道负载均衡', '支持GPT/Claude/Gemini全系列', '运营时间长口碑好'], cons: ['付费使用', '需充值'], tips: '充值前先小额测试稳定性' },
  { id: 'bltcy-ai', name: '柏拉图AI', url: 'https://api.bltcy.ai', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude'], desc: '柏拉图AI是付费中转API，Azure 渠道低价 GPT 与 Claude 中转。适合企业级调用，官方渠道稳定性高。', tagline: '柏拉图AI｜Azure渠道低价付费中转', features: ['付费', 'OpenAI兼容'], apiBase: 'https://api.bltcy.ai', register: '开放注册', billing: 'Azure渠道低价', payment: '支付宝/微信' },
  { id: 'no1-api', name: 'No.1-API', url: 'https://api.rcouyi.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'DeepSeek'], desc: 'No.1-API是付费中转API，支持 GPT、Claude、DeepSeek 多模型按 token 计费。适合开发者与研究者，模型丰富。', tagline: 'No.1-API｜多模型付费中转', features: ['付费', '多模型'], apiBase: 'https://api.rcouyi.com', register: '开放注册', payment: '支付宝/微信' },
  ...
  { id: 'cloudflare', name: 'Cloudflare Workers AI', url: 'https://developers.cloudflare.com/workers-ai', category: 'overseas', type: 'free', status: 'ok', models: ['Llama-3.3-70b', 'Llama-4', 'gpt-oss-120b', 'kimi-k2', 'gemma-4', 'glm-4.7', 'deepseek-r1'], desc: 'Cloudflare Workers AI是免费模型API，依托边缘网络低延迟推理并每日送免费额度。适合开发者，海外多模型可用。', tagline: 'Cloudflare Workers AI｜海外边缘免费推理', features: ['免费', '海外', '多模型', '低延迟'], apiBase: 'https://api.cloudflare.com/client/v4/accounts/{id}/ai/run', register: 'Cloudflare账号', billing: '每日10000 Neurons免费', note: '边缘网络低延迟全球分布', pros: ['每日10000 Neurons免费', '边缘网络低延迟', '50+模型可选'], cons: ['需Cloudflare账号', '部分模型质量一般'], tips: 'Llama-3.3-70b效果最好，适合通用对话' },
...
{ id: 'aierxin', name: '尔信中转站', url: 'https://aierxin.cc', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT全系', 'Claude'], desc: '自建号池低倍率中转：gpt-pro 号池约官方 0.25 倍、混合池低至 0.08 倍；国内直连，公众号同步倍率动态。', tagline: '自建号池 · 低倍率 · 国内直连', features: ['按量计费', '号池', '国内直连'], apiBase: 'https://aierxin.cc', tips: '2026-08-22 二轮巡检：本机+外部双线路探测均 HTTP 451（WAF 合规拦截），但 Veridrop 实测中位 99/100（7 月末 4 样本）、V2EX/社区推广活跃、官网页面可被搜索引擎索引——判定存活，属反爬拦截不降级' },
{ id: 'koozhan', name: '酷站AI', url: 'https://api.koozhan.com', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini'], desc: '第三方真伪检测平台 Veridrop 公开检测中位 99/100（297 样本），GPT/Claude/Gemini 主力型号全过检。', tagline: '公开检测高分的商用网关', features: ['按量计费', '检测背书'], apiBase: 'https://api.koozhan.com', tips: '2026-08-22 二轮巡检：api.koozhan.com 根路径与 /api/status 返回 404 属网关正常行为；主站 koozhan.com 活跃运营（2026-08-20 发布调价公告）且官方文档确认 base_url 即 https://api.koozhan.com/v1——存活，不判死' },
{ id: 'runapi', name: 'RunAPI', url: 'https://runapi.host', category: 'paidrelay', type: 'paid', status: 'ok', models: ['GPT', 'Claude', 'Gemini', 'DeepSeek'], desc: '国内直连的 OpenRouter 式聚合路由，300+ 模型智能切换，支持 Claude Code / OpenClaw 一键接入。', tagline: '国内直连聚合路由', features: ['按量计费', '智能路由', '国内直连'], apiBase: 'https://runapi.host', tips: '2026-08-22 二轮巡检：本机 HEAD 探测偶发 502，外部网络 GET 正常返回完整主页（价格/文档指向 runapi.co）——502 为探测端瞬时误报，存活' },
];
