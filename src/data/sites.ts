...
export const sites: Site[] = [
  ...
  { id: 'rawchat', name: 'RawChat 主站', url: 'https://chatgptplus.cn', category: 'linuxdo', type: 'free', status: 'ok', models: ['GPT-4o', 'Plus全套'], desc: 'RawChat 主站是免费模型API，提供无需注册的公益共享 Plus 账号。适合新手与开发者，免登录即可体验 GPT-4o。（社区共享付费账号，可能违反 OpenAI ToS，风险自负）', tagline: 'RawChat 主站｜免费公益共享Plus账号', features: ['免费', '公益', '无需注册'], note: '社区共享付费账号，可能违反 OpenAI ToS，风险自负' },
