...
export const sites: Site[] = [
  ...
  { id: 'aizzz', name: 'AIZZZ', url: 'https://api.aizzz.xyz', category: 'linuxdo', type: 'freemium', status: 'ok', models: ['GPT', 'Claude'], desc: 'AIZZZ是免费模型API，Linux.do 社区站注册送免费额度，支持 GPT 与 Claude。适合个人开发者轻量使用。', tagline: 'AIZZZ｜Linux.do免费额度GPT/Claude', features: ['免费额度', 'Linux.do'], apiBase: 'https://api.aizzz.xyz', register: '开放注册' },
