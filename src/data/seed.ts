...
const curated: Resource[] = [
  ...
  mk('free-api', '阶跃星辰 StepFun', 'https://platform.stepfun.com', {
    ...
    tags: ['官方', '国产', 'OpenAI兼容'], models: ['Step-2', 'Step-3.5-Flash'],
  ...
  mk('free-api', 'Kimi 开放平台', 'https://platform.kimi.com', {
    ...
    tags: ['API', '国产', '官方'], pros: ['长上下文', '中文好'], cons: ['高峰限速'],
  }),
  ...
  mk('tools', 'Codeium (已并入 Devin)', 'https://devin.ai', {
