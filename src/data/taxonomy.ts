...
export const subTypes: SubType[] = [
  ...
  {
    slug: 'ai-agent',
    name: { zh: 'AI Agent / 智能体', en: 'AI Agents', ja: 'AIエージェント' },
    icon: 'Bot',
    color: '#6366f1',
    description: {
      zh: 'AI 智能体平台与框架：Coze、Dify、AutoGPT、LangGraph 等，构建自主 Agent。',
      en: 'AI agent platforms & frameworks: Coze, Dify, AutoGPT, LangGraph and more.',
      ja: 'AIエージェントプラットフォーム・フレームワーク：Coze、Dify、AutoGPT、LangGraphなど。',
    },
    sort: 15,
  },
  {
    ...
    color: '#14b8a6',
    description: {
      zh: '开源大模型仓库与下载：HuggingFace、ModelScope、Ollama Library 等。',
      en: 'Open model repositories & downloads: HuggingFace, ModelScope, Ollama Library.',
      ja: 'オープンソースモデルリポジトリ・ダウンロード：HuggingFace、ModelScope、Ollama Library。',
    },
    sort: 16,
  },
  {
    ...
    color: '#f43f5e',
    description: {
      zh: '免费可直连的 ChatGPT / Claude 等对话镜像站，开箱即用，无需配置。',
      en: 'Free, directly-accessible ChatGPT / Claude chat mirror sites — ready to use, no setup.',
      ja: '設定不要ですぐ使える ChatGPT/Claude 等の無料チャットミラーサイト。',
    },
    sort: 17,
  },
];
