        ...
        <div className="grid grid-cols-1 gap-8 text-sm sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-[var(--color-muted)]">
              <li>
                <a className="inline-flex items-center gap-1 hover:text-[var(--color-primary)]" href="https://github.com/Morningstar202604/OpenBox" target="_blank" rel="noreferrer">
                  <Icon name="GitBranch" size={13} /> {t('about.source')}
                </a>
              </li>
              <li>
                <a className="inline-flex items-center gap-1 hover:text-[var(--color-primary)]" href="https://github.com/Morningstar202604/OpenBox/issues/new" target="_blank" rel="noreferrer">
