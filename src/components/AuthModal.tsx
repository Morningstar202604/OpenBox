...
export function AuthModal() {
  ...
  return (
    <Modal open={show} onClose={closeAuth} ariaLabel={mode === 'signin' ? t('auth.signIn') : t('auth.signUp')}>
      <ModalHeader
        title={<h2 className="text-lg font-semibold">{mode === 'signin' ? t('auth.signIn') : t('auth.signUp')}</h2>}
        onClose={closeAuth}
